...
public class ProductDto {
	...
	/*
	 * 매입 단가를 setting(입력) 하면 매출 단가를 자동으로 계산하여 저장하기 매입 단가를 DTO 에 저장 할때는 pIprice = 얼마를
	 * 사용하지 않고 setIPrice(얼마) 코드를 사용한다.
	 */
	...
	/*
	 * pIprice 는 변수에 직접 접근할수 없도록 private 로 선언했다.
	 * 만약 외부에서 product 객체를 통하여 pIprice 값을 읽으려고 하면
