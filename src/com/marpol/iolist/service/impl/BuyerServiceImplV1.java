...
public class BuyerServiceImplV1 implements BuyerService {
	...
	public BuyerServiceImplV1() {
		...
		// new 생성자를 사용하지 않고
		// SqlSession의 getMapper() method 를 통하여
...
//				System.out.println("새로 생성된 ID : " + strBuId);
			...
			// 고객ID 를 setting
			if(buyerDto == null) { buyerDto = new BuyerDto();
...
//		System.out.println("고객정보" + buyerDto);
		...
		while(true) {
			String prompt = buyerDto.buName == null ? "새로운 고객명 >>" : String.format("고객명 수정 (%s) >> ", buyerDto.buName);
